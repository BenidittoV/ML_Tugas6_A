...
model = load_model(r"D:\Ditto\Kuliah\Matkul\Semester 5\ML\Pertemuan 14\Tugas6_X_YYYYY\gugelnet.h5")
...
st.title("Prediksi Kematangan Buah Naga - 1605")  
